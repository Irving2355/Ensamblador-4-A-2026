...
msgLimpio db 'El buffer fue limpiado$'
...
main:
    ...
    ;mostrar el titulo en una posicion 
    ...
    ;copiar la cadena a la otra variable
    ...
    ;decir que el buffer ya fue limpiado
